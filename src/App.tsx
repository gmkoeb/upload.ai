      ...
      <main className="flex-1 p-6 flex gap-6">
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6" action="" method="post">
            <label htmlFor="video" className="border w-full flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary/5">
